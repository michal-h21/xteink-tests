...
% \setmainfont{Bitter} % tenhle font nepodporuje některý český znaky, takže je nepoužitelnej
...
% Ale Crosspoint má omezenej viewport, na 464×765 pixelů, takže musíme použít takovou deklaraci:
\usepackage[
  paperwidth=151.85bp,
...
\usepackage[characters=30,scale=heptatonic]{responsive}
...
který vytváří soubor, co přečte i Crosspoint. Teda aspoň ten černobílej, umí i soubor XTCH, se 4 odstínama šedi, ale 
ten Crosspoint neotevře s hláškou \texttt{Memory error}. 
